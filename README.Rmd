...
@pranavpandya84) was retired because it doesn't seem to work (the questions
seems to not filter the data).

* The second attempt
([r2dii.scenario.selector](https://github.com/2DegreesInvesting/r2dii.scenario.selector);
@jdhoffa) is a lighter version of the fist one -- built from the top down. It
was also retired because it inherited the bugs of the first one, and still has
